...
train_folder_name = 'Training' # 학습 데이터가 저장된 폴더 이름
...
print(f"학습한 데이터에 대해서 과일의 분류 정확도는 {class_accuracy}% 입니다.")
print(f"학습한 데이터에 대해서 과일의 품질 예측 정확도는 {quality_accuracy}% 입니다.")
